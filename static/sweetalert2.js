!function(t, e) {
    ...
    function qt(t, s) {
        ...
        l >= s.progressSteps.length && N("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), s.progressSteps.forEach(function(t, e) {
            var n,
                ...
                r,
                a,
                c = (n = t, o = document.createElement("li"), pt(o, W["progress-step"]), V(o, n), o);
    ...
    function Qt(t) {
        for (var e in t)
            Yt(i = e) || N('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== te.indexOf(o) && N('The parameter "'.concat(o, '" is incompatible with toasts'))), Zt(n = e) && g(n, Zt(n));
        var n,
            o,
            i
    }
    ...
    function be(t) {
        var e = Y(),
            n = Z();
        "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), Oe(e, n, t), Be(e, n), I() && Se(e, t.scrollbarPadding), Q() || $t.previousActiveElement || ($t.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function() {
            return t.onOpen(n)
    ...
    function we(t, e) {
        "select" === e.input || "radio" === e.input ? qe(t, e) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(e.input) && v(e.inputValue) && Ie(t, e)
    }
    function Ce(t, e) {
    ...
    }), on.DismissReason = z, on.version = "9.14.0";
    var rn = on;
